...
const enabledFeatures = Settings.features.split(';');

router.get('/features/v1/:feature', async function (req, res, next) {
  res.json({ statusCode: 200, enabled: enabledFeatures.includes(req.params.feature) || false, success: true });
});
